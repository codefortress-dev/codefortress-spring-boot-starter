...
class CodeFortressAutoConfigurationTest {
    ...
    static class CustomUserProvider implements CodeFortressUserProvider {
        @Override
        public java.util.Optional<com.codefortress.core.model.CodeFortressUser> findByUsername(String username) {
            return java.util.Optional.empty();
        }
        @Override
        public com.codefortress.core.model.CodeFortressUser save(com.codefortress.core.model.CodeFortressUser user) {
            return user;
        }
    }
